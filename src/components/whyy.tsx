    ...
    <div className="relative w-full h-full min-h-[500px] overflow-hidden rounded-lg shadow-2xl bg-gradient-to-br from-[#8CB8B4] to-[#EEC71B]">
      <AnimatePresence initial={false}>
        <motion.div
          ...
          className="absolute inset-0 flex items-start min-h-[500px] p-6 sm:p-8"
        >
          <div className="w-full flex flex-col text-left">
            <div className="mb-6">
              <motion.span
                ...
                className="text-5xl sm:text-6xl lg:text-7xl text-white inline-block mb-4"
              >
            ...
            >
              {items[currentIndex].bullets.map((bullet, index) => (
                <li key={index} className="flex items-start text-white">
                  <FiCheck
                    className="mr-4 flex-shrink-0 text-[#EEC71B] w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 mt-1"
                    aria-hidden="true"
                  />
...
const WhyChooseWebWorksSection: React.FC = () => {
  ...
  return (
    <section className="relative pt-5 mt-10 sm:mt-20 pb-10 sm:pb-20 px-4 sm:px-6 lg:px-8">
      <div className="absolute inset-0 bg-web-pattern rounded-t-xl" />
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-8 sm:gap-10">
          <div className="lg:w-2/5 min-h-[500px] lg:sticky lg:top-4">
            <Carousel items={carouselItems} />
          </div>

          <div className="lg:w-3/5">
            <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 h-full overflow-hidden flex flex-col">
              <div className="flex flex-wrap justify-start gap-2 mb-6 sm:mb-8 px-2">
