...
const baseColorSchemes = [
  ...
  { id: "neon", name: "Neona", colors: ["#ff00ff", "#00ffff", "#ff9900"] },
  {
    id: "earthy",
    name: "Zemes toņi",
  ...
  { id: "retro", name: "Retro", colors: ["#FFD700", "#FF6347", "#4169E1"] },
  {
    id: "futuristic",
    name: "Futuristiska",
...
const SketchBuilderComponent: React.FC<any> = ({
  ...
  return (
    <div className="p-4 border rounded-lg bg-white shadow-md">
      ...
      <div className="mt-4">
        <h3 className="text-lg font-semibold mb-2">AI Ģenerētais Saturs:</h3>
        <p className="whitespace-pre-wrap">{aiGeneratedContent}</p>
      </div>
      <div>
        <p className="font-semibold mt-4">Interaktīvie Elementi:</p>
        <ul className="list-disc pl-5">
    ...
    <div className="bg-white p-6 rounded-lg shadow-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <p>
            <strong>Tips:</strong>{" "}
            {websiteTypes.find((type) => type.id === websiteType)?.name}
          </p>
          <p>
            <strong>Krāsu shēma:</strong> {currentColorScheme?.name}
          </p>
          ...
          <p>
            <strong>Izkārtojums:</strong>{" "}
            {layouts.find((l) => l.id === layout)?.name}
          </p>
          <p>
            <strong>Fonta stils:</strong>{" "}
            {fontStyles.find((f) => f.id === fontStyle)?.name}
          </p>
...
//       pdf.addImage(imgData, "PNG", 0, 0, pdfWidth, pdfHeight);
//       pdf.save("website_sketch.pdf");
//       toast.success("Skice eksportēta kā PDF!");
//     }
//   };
...
//   return (
//     <div className="p-6 bg-gray-100 min-h-screen">
//       <h1 className="text-3xl font-bold mb-6">Mājaslapas Skices Veidotājs</h1>
//       {!previewMode && (
//         <div className="mb-6">
//           <h2 className="text-2xl font-semibold mb-4">{steps[step].title}</h2>
//           <div className="bg-white rounded-lg shadow-md p-6">
...
//       </div>
//       {previewMode && (
//         <div ref={sketchRef} className="bg-white rounded-lg shadow-md p-6">
//           <SketchPreview
//             websiteType={websiteType}
//             colorScheme={colorScheme}
//             customColorScheme={customColorScheme}
...
//       <div className="mt-6">
//         <h3 className="text-xl font-semibold mb-2">Interaktīvie Elementi</h3>
//         {safeInteractiveElements.length > 0 ? (
//           <ul className="list-disc pl-5">
//             {safeInteractiveElements.map((element, index) => (
