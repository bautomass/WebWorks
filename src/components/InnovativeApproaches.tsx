...
//   ({ icon, title, description, features, index }) => (
//     <motion.div
//       className="bg-white bg-opacity-90 rounded-lg shadow-lg p-6 relative overflow-hidden"
//       initial={{ opacity: 0, y: 20 }}
//       animate={{ opacity: 1, y: 0 }}
...
//       {
//         icon: <FiZap />,
//         title: "Ātrums un Veiktspēja",
//         description:
//           "Mūsu risinājumi nodrošina zibens ātru ielādes laiku un nevainojamu veiktspēju.",
//         features: [
//           "Serveru puses renderēšana (SSR) ātrākai sākotnējai ielādei",
//           "Progresīvās tīmekļa lietotnes (PWA) bezsaistes funkcionalitātei",
//           "Adaptīvā attēlu ielāde optimālai veiktspējai",
//           "Kešatmiņas stratēģijas ātrākai datu piekļuvei",
//         ],
//       },
//       {
//         icon: <FiUsers />,
//         title: "Lietotāju Pieredze",
//         description:
//           "Radām intuitīvas un aizraujošas lietotāju saskarnes, kas piesaista un notur klientus.",
//         features: [
//           "Lietotāju uzvedības analīze reāllaikā",
//           "A/B testēšana UI/UX uzlabojumiem",
//           "Personalizēti lietotāju ceļojumi",
//           "Vairāku valodu un lokalizācijas atbalsts",
//         ],
//       },
//       {
//         icon: <FiLock />,
...
//         description:
//           "Jūsu dati un lietotāju informācija ir mūsu augstākā prioritāte.",
//         features: [
//           "Automātiska ievainojamību skenēšana un novēršana",
//           "Mākslīgā intelekta izmantošana draudu atklāšanā",
//           "Blockchain tehnoloģiju integrācija datu integritātei",
//           "Biometriskā autentifikācija paaugstinātai drošībai",
//         ],
//       },
//       {
//         icon: <FiGlobe />,
//         title: "Globāla Mērogojamība",
//         description:
//           "Mūsu risinājumi ir gatavi globālai izaugsmei un starptautiskai darbībai.",
//         features: [
//           "Daudzvalodu un daudzkultūru atbalsts",
//           "Ģeogrāfiskā sadalījuma (CDN) izmantošana ātrākai piegādei",
//           "Elastīga infrastruktūra automātiskai mērogošanai",
//           "Globālo normatīvo aktu (GDPR, CCPA) ievērošana",
//         ],
//       },
//       {
//         icon: <FiCloud />,
//         title: "Mākoņa Tehnoloģijas",
//         description:
//           "Izmantojam jaunākās mākoņa tehnoloģijas efektīviem un elastīgiem risinājumiem.",
//         features: [
//           "Serverless arhitektūra izmaksu optimizācijai",
//           "Konteineru orkestrācija ar Kubernetes",
//           "Mikropakalpojumu arhitektūra elastīgai attīstībai",
//           "Reāllaika datu sinhronizācija starp mākoņiem",
//         ],
//       },
//     ],
//     []
